...
def snippet_4():
    ...
    #By using 'and' instead of 'or', we include both comparisons, and the 'not' negates the second comparison, making 'd' false. Had we left 'or', the result would have been 'True' because the first comparison is in fact true.
